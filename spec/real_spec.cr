...
describe Z3::RealExpr do
  ...
  it "operators with the literal on the left" do
    ...
    [a == 2, b == 0.5 + a].should have_solution(b == BigRational.new(5, 2))
    [a == 2, b == BigRational.new(1, 2) + a].should have_solution(b == BigRational.new(5, 2))
  ...
  it "abs" do
    ...
    [a == 2.5, b == -a.abs].should have_solution(b == BigRational.new(-5, 2))
  end
  ...
  it "unary -" do
    ...
    [a == 3.5, b == -a].should have_solution(b == BigRational.new(-7, 2))
    [a == BigRational.new(4, 3), b == -a].should have_solution(b == BigRational.new(-4, 3))
  end
